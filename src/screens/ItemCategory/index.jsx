...
function Page() {
  ...
  const setupFields = () => {
    setFields([
      ...
      {label: 'Design Qty A', field: 'designQtya', align:'right', decimal:4},
      {label: 'Design Qty B', field: 'designQtyb', align:'right', decimal:4},
      {label: 'Design Qty C', field: 'designQtyc', align:'right', decimal:4},
      {label: 'Design Qty D', field: 'designQtyd', align:'right', decimal:4},
